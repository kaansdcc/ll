...
exports.run = async(bot, message, args, client) => {
  if (!args[0]) return message.channel.send(`<a:pencil:705564588783173642> Komutu kullanmaya devam etmek için birşey belirtmelisiniz! <a:spheli:705564588783173642>\n<a:bell:646066154925981773> Örnek kullanım: **ekle**, **sil**, **bilgi**, **düzenle** şeklinde.`)
