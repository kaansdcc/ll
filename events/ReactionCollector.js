...
class ReactionCollector extends Base {
    ...
    constructor(client, message, filter, options = {}) {
        ...
        this.message = message;//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
        this.users = new Map();
        this.total = 0;
        ...
        this.once("end", () => {
            ...
            client.removeListener("messageDelete", this._handleMessageDeletion);//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
        ...
        this.on("remove", (reaction, user) => {
            this.total--;//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
    ...
    empty() {
        this.total = 0;//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
    ...
    _handleGuildDeletion(guild) {
        if (this.message.guild && guild.id === this.message.guild.id) {//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
